...
set border 2 lw 0.5
set noarrow
plot [0:1.1][] "../../data/input1.nbar" using 1:($2+1) with steps linetype -1 linewidth 1
set arrow from 5,-1.5 to 25,-1.5 nohead lw 2
set label 2 '{/=6 10 s^{/=4 -1}}' at -1,-5
plot [0:34][] "odour_baseline.nbar" using 1:($2+1.1) with steps lt -1 linewidth 0.5

set origin 0.45,0.125
set noarrow
set nolabel
plot [0:34][] "odour_baseline.gran.nbar" using 1:($2+1) with steps lt -1 linewidth 0.2
